var softConfig = {
    ...
    headTags: [
        ...
        { type: 'meta', attributes: [ { attribute: 'name', value: 'description' }, { attribute: 'content', value: '' } ] },
        ...
        { type: 'meta', attributes: [ { attribute: 'property', value: 'og:title' }, { attribute: 'content', value: 'Jogo dos porquês' } ] },
        { type: 'meta', attributes: [ { attribute: 'property', value: 'og:description' }, { attribute: 'content', value: '' } ] },
        { type: 'meta', attributes: [ { attribute: 'property', value: 'og:url' }, { attribute: 'content', value: '' } ] },
        { type: 'meta', attributes: [ { attribute: 'property', value: 'og:site_name' }, { attribute: 'content', value: 'Jogo dos porquês' } ] }
